# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 19:56:09 2023
...
# Create buttons for Digit Detection and Alphabet Detection
if st.button("Digit Detection"):
    st.subheader("Digit Detection")
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            if cleaned_landmark:
                clf = joblib.load('C:/Users/Kalpesh/Desktop/DBDA Project Final/Digits/pkl_digits.pkl')  # Adjust the path accordingly
...
if st.button("Alphabet Detection"):
    st.subheader("Alphabet Detection")
    frame_container = st.empty()
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            if cleaned_landmark:
                clf = joblib.load('C:/Users/Kalpesh/Desktop/DBDA Project Final/Alphabets/model.pkl')  # Adjust the path accordingly
                y_pred = clf.predict(cleaned_landmark)
                frame_rgb = cv2.putText(frame_rgb, str(y_pred[0]), (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 2, cv2.LINE_AA)
